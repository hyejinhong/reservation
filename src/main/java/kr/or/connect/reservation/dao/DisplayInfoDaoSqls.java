...
public class DisplayInfoDaoSqls {
	...
	public static final String SELECT_ALL_CATEGORY_AND_START =
	...
	public static final String SELECT_BY_CATEGORY_ID_AND_START =
	...
	public static final String SELECT_PRODUCT_COUNT_ALL_CATEGORY_AND_START =
			"SELECT count(DISTINCT product_id)-:start FROM display_info INNER JOIN product ON display_info.product_id=product.id INNER JOIN category ON product.category_id = category.id";
	
	public static final String SELECT_PRODUCT_COUNT_BY_CATEGORY_ID =
			"SELECT count(DISTINCT product_id) FROM display_info INNER JOIN product ON display_info.product_id=product.id INNER JOIN category ON product.category_id = category.id WHERE category_id=:category_id";

	public static final String SELECT_PRODUCT_COUNT_BY_CATEGORY_ID_AND_START =
			"SELECT count(DISTINCT product_id)-:start FROM display_info INNER JOIN product ON display_info.product_id=product.id INNER JOIN category ON product.category_id = category.id WHERE category_id=:category_id";
